...
data = pd.read_csv('datasets/lucca_small_100per.csv',dtype={"uid": np.int64 ,"lon": np.float32,"lat": np.float32,"speed": np.float16},parse_dates=["ts"],usecols=["uid","lon","lat","speed","ts"])
